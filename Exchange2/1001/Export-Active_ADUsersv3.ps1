...
$userInfo = $users | ForEach-Object {
    ...
    [PSCustomObject]@{
        ...
        'Proxy Addresses'             = ($smtpAddresses -join ', ')
    }
}

$userInfo | Export-Csv -Path "C:\Code\Exchange\Exports\AGH_October_3rd_2023_15_30_PM_AD_Users_PowerShell_Export_V7.csv" -NoTypeInformation
