...
$totalEmailCheckPassed = ($results | Where-Object { $_.EmailAddressCheck -like "*@glebecentre.mail.onmicrosoft.com*" }).Count
$totalEmailCheckFailed = ($results | Where-Object { $_.EmailAddressCheck -notlike "*@glebecentre.mail.onmicrosoft.com*" }).Count
$totalEmailCheckblank = ($results | Where-Object { $_.EmailAddressCheck -eq $false }).Count
...
Write-Host "$(Get-Date) - [INFO] Total Users Did Not Pass Email Check blank: $totalEmailCheckblank" -ForegroundColor Yellow
