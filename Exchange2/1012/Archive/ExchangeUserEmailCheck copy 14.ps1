...
$totalEmailCheckFailed = ($results | Where-Object { $_.EmailAddressCheck -eq $false -or $_.EmailAddressCheck -eq "{}" }).count
$totalEmailCheckblank = ($results | Where-Object { $_.EmailAddressCheck -eq $null}).count
