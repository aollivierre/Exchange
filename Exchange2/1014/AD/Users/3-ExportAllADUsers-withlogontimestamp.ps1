...
$users = Get-ADUser -Filter * -Properties LastLogonDate, LastLogon, DistinguishedName, Enabled
...
$csvExportPath = "${exportPath}all_users.csv"
...
Write-Host "Total number of users in the domain: $($users.Count)" -ForegroundColor Green
