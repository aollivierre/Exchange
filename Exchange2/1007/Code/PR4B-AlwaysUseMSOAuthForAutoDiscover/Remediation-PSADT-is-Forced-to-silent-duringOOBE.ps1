...
C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -Command "if (-Not (Test-Path 'HKLM:\Software\Microsoft\Exchange')) { New-Item -Path 'HKLM:\Software\Microsoft\Exchange' -Force }; Set-ItemProperty -Path 'HKLM:\Software\Microsoft\Exchange' -Name 'AlwaysUseMSOAuthForAutoDiscover' -Value 1"





# %SystemRoot%\sysnative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -File "C:\code\Outlook\AlwaysUseMSOAuthForAutoDiscover.ps1"
