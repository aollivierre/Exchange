...
$Users | Export-Csv -Path "C:\Code\CB\Exchange\CHFC\Exports\ExchangeUsers.csv" -NoTypeInformation

# Export groups to separate CSV files
$UsersMoreThanThreshold | Export-Csv -Path "C:\Code\CB\Exchange\CHFC\Exports\UsersMoreThanThreshold.csv" -NoTypeInformation
$UsersLessThanThreshold | Export-Csv -Path "C:\Code\CB\Exchange\CHFC\Exports\UsersLessThanThreshold.csv" -NoTypeInformation
