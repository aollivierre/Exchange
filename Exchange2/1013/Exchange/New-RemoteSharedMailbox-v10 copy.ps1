...
function New-EnhancedRemoteMailbox {
    ...
    try {
        ...
        # Create remote mailbox with correct routing address format
        $remoteRoutingAddress = "$($Name.ToLower())@$TenantName.mail.onmicrosoft.com"
        ...
        Write-Host "Creating remote mailbox with routing address: $remoteRoutingAddress" -ForegroundColor Yellow
...
# Get password and create mailboxes
