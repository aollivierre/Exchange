...
$domainName = 'NTI-OTT-EXCH01.ott.nti.local'

#uncomment the following connection tests when debugging
# ping 'NTI-OTT-EXCH01.ott.nti.local'
# nslookup 'NTI-OTT-EXCH01.ott.nti.local'
# Test-NetConnection $domainName -Port 5985

# Path to the credentials file
$SecretsFile = Join-Path -Path $PSScriptRoot -ChildPath 'secrets.exchange.ott.nti.local.psd1'
