...
$domainName = 'NTI-IQ-EX01.iq.nti.local'

#uncomment the following connection tests when debugging
# ping 'NTI-IQ-EX01.iq.nti.local'
# nslookup 'NTI-IQ-EX01.iq.nti.local'
# Test-NetConnection $domainName -Port 5985

# Path to the credentials file
$SecretsFile = Join-Path -Path $PSScriptRoot -ChildPath 'secrets.exchange.iq.nti.local.psd1'
