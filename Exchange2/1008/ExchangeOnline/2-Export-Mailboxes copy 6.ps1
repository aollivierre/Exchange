...
$mailboxes = Get-Mailbox -ResultSize Unlimited | Select-Object DisplayName, UserPrincipalName, PrimarySmtpAddress, RecipientTypeDetails, WhenMailboxCreated | Sort-Object WhenMailboxCreated
$mailboxes | Export-Csv -Path "$env:USERPROFILE\Desktop\AllMailboxes.csv" -NoTypeInformation
