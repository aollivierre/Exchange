function Compare-ExchangeUserProperties {
    ...
    $properties1 = Get-RemoteMailbox -Identity $User1 | Select-Object -Property * -ExcludeProperty PropertyNames, PropertyCount, PropertyLength
    $properties2 = Get-RemoteMailbox -Identity $User2 | Select-Object -Property * -ExcludeProperty PropertyNames, PropertyCount, PropertyLength
...
Compare-ExchangeUserProperties -User1 "JHeuser" -User2 "RLandriault"
