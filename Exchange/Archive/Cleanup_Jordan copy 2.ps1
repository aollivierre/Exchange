...
if ($mailbox) {
    ...
    Write-Host "No mailbox or mail user found for jgauthier@contoso.com." -ForegroundColor Red
}
...
if (-not $mailbox -and -not $mailUser) {
    ...
    try {
        New-RemoteMailbox -Name "jgauthier" -Alias "jgauthier" -UserPrincipalName "jgauthier@contoso.com" -PrimarySmtpAddress "jgauthier@contoso.com" -RemoteRoutingAddress "jgauthier@contoso.com.mail.onmicrosoft.com"
