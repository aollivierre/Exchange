...
if ($mailbox) {
    ...
    Write-Host "No mailbox or mail user found for jgauthier@arnpriorhealth.ca." -ForegroundColor Red
}
...
if (-not $mailbox -and -not $mailUser) {
    ...
    try {
        New-RemoteMailbox -Name "jgauthier" -Alias "jgauthier" -UserPrincipalName "jgauthier@arnpriorhealth.ca" -PrimarySmtpAddress "jgauthier@arnpriorhealth.ca" -RemoteRoutingAddress "jgauthier@arnpriorhealth.mail.onmicrosoft.com"
