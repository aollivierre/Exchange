...
> 🔔 **Note:** It's recommended to enable all writeback in the traditional Azure AD Connect Sync (Entra ID Connect Sync) towards the very end of the setup wizard for consistency.
